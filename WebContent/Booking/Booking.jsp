...
<%@ page import="Com.Booking.BookedSeats" %> <!-- Import your Booking class -->
<%@ page import="Com.customer.Customer" %> <!-- Import your Customer class -->
<%@ page contentType="text/html;charset=UTF-8" language="java" %>
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<c:url value='/CSS/BookingStyles.css' />"><style type="text/css">
...
<c:forEach var="seat" items="${bookedSeatsList}">
    ...
    <form id="seatForm" action="<c:url value='/Booking' />" method="post">
    ...
    <div class="form-container">
          ...
          <div class="f">
            ...
            <input type="text" id="origin" class="search-input" name="origin" value="${borigin}" readonly>
        </div>
        <div class="t">
            <label for="destination">To:</label>
            <input type="text" id="destination" class="search-input" name="destination" value="${bdestination}" readonly>
        </div>
        <div class="d">
            <label for="date">Date:</label>
            <input type="text" class="datepicker" id="date" name="date" value="${bdate}">
        </div>
        <div class="f">
            <label for="busNumber">Bus Number:</label>
            <input type="text" id="busNumber" class="search-input" name="busNumber" value="${bbusNumber}" readonly>
        </div>
        <div class="t">
            <label for="time">Time</label>
            <input type="text" id="time" class="search-input" name="time" value="${btime}" readonly>
        </div>
        <div class="d">
            <label for="price">Price of One seat</label>
            <input type="text" id="price" class="search-input" name="price" value="${price}" readonly>
            <input type="hidden" id="price" class="search-input" name="booked" value="${seat}" readonly>
        </div>
         <div class ="book"> <input type="submit" value="Book"></div>
        <label for="cusid"></label>
        <input type="hidden" name="cusid" value="<%=session.getAttribute("retrievedId")%>" />
       <div id="selected-seats"><br>
        ...
        <div  id="selected-seat-count">Selected Seats Count:
        </div></div>
